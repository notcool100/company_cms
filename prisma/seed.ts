...
More content will be added to this page before it is published.
	...
	const services = [
		...
		},
		{
			...
			description:
				"Expert database design, optimization, and management to ensure your data is secure and accessible.",
			icon: "database",
		},
		{
		...
		},
		{
			title: "IT Consulting",
			description:
				"Expert advice and guidance to help you make informed decisions about your IT strategy.",
			icon: "chart",
		},
		{
			title: "Cybersecurity",
			description:
				"Comprehensive security solutions to protect your business from threats and ensure data integrity.",
			icon: "shield",
		},
		{
			title: "Technical Support",
			description:
				"Responsive and reliable technical support to keep your systems running smoothly.",
			icon: "support",
		},
	];
	...
	const sections = [
		...
		},
		{
			...
			isVisible: true,
			description: "Our services showcase",
		},
		{
			sectionId: "tech-stack",
			name: "Technology Stack",
			isVisible: true,
			description: "Our technology stack showcase",
		},
		{
			sectionId: "about",
			name: "About Section",
	...
	console.log("Section visibility seeded successfully");
