        ...
        <div className="flex flex-col items-center text-center space-y-6 md:space-y-8">
          ...
          <div className="animate-fade-in-up animation-delay-300">
            <AnimatedText
              ...
              className="text-xl md:text-2xl text-white/90 max-w-[800px] drop-shadow-md"
            />
          </div>
          <div className="flex flex-col sm:flex-row gap-4 mt-8 animate-fade-in-up animation-delay-600">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="text-white border-white hover:bg-white/10 backdrop-blur-sm transition-all duration-300 hover:scale-105"
              asChild
            >
              <a href="#contact">
                Contact Us
